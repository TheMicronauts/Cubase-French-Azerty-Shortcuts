...
Ce dépôt propose les raccourcis clavier de Cubase que je recommande à mes étudiants pour la production de musique électronique (appelés « _Key Commands_ »). Vous les trouverez dans des tableaux à consulter en ligne ou télécharger, et en preset XML à importer dans le logiciel.
