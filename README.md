...
Les raccourcis clavier sont un excellent moyen de contourner le champ de mines de l’interface, et rapprocher ainsi Cubase d’un instrument de musique. Malheureusement, les presets proposés par Steinberg font le service minimum. Prendre le temps de choisir, programmer et apprendre par cœur des raccourcis mieux adaptés change véritablement la vie. Ce dépôt vise à vous mâcher le travail.
